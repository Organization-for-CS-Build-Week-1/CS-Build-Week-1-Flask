...
class Rooms(DB.Model):
    ...
    north_id = DB.Column(DB.Integer, DB.ForeignKey("rooms.id"), nullable=True)
    south_id = DB.Column(DB.Integer, DB.ForeignKey("rooms.id"),  nullable=True)
    east_id = DB.Column(DB.Integer, DB.ForeignKey("rooms.id"),  nullable=True)
    west_id = DB.Column(DB.Integer, DB.ForeignKey("rooms.id"),  nullable=True)
